...
const passwordGenerator1 = () => {
	...
	const generatePassword = (
		...
		for (let i = 0; i < length; i++) {
			const oldPassword = generatedPassword.split('');
			password = oldPassword[Math.floor(Math.random() * generatedPassword.length)];
			
			generatedPassword = generatedPassword.splice(password, 1);
...
const passwordGenerator2 = () => {
	...
	const generatePassword = (
		...
		const selectedChar = hasUppercase + hasLowercase + hasNumbers + hasSymbols;
